...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //`----+----+----+----+----+----+----/    \----+----+----+----+----+----+----'
                       LCTL, FNC,SJPL         ,SJPR, NUM, MRK
  //                  `----+----+----'        `----+----+----'
  ),

  [_SLMSKYTOUCH] = LAYOUT( \
    //,-------+-----------+-----------+-----------+-----------+-----------.                           ,-----------+-----------+-----------+-----------+-----------+-----------.
      KC____  , JP_SCLN   , KC____    , KC_J      , KC_F      , KC_Q                                  , KC____    , KC____    , KC____    , KC____    , KC____    , KC____    ,
    //,-------+-----------+-----------+-----------+-----------+-----------.                           ,-----------+-----------+-----------+-----------+-----------+-----------.
      KC____  , KC____    , KC_Z      , KC_D      , KC_G      , KC_DNN                                , KC____    , KC____    , KC____    , KC____    , KC____    , KC____    ,
    //,-------+-----------+-----------+-----------+-----------+-----------.                           ,-----------+-----------+-----------+-----------+-----------+-----------.
      KC____  , KC_B      , KC_V      , KC_P      , KC_B      , KC____                                , KC____    , KC____    , KC____    , KC____    , KC____    , KC____    ,
  //`---------+-----------+-----------+-----------+-----------+-----------+-----------/    \----------+-----------+-----------+-----------+-----------+-----------+-----------'
                                                  KC____    , KC_FNC    , KC_SJPL        ,KC_SJPBR    , KC____    ,KC____
  //                                             `----------+-----------+-----------'    `----------+-----------+-----------'
  ),
